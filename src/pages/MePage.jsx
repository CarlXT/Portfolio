...
import { IntroSection } from "../components/me/IntroSection";
import { PrinciplesSection } from "../components/me/PrinciplesSection";
import { ResumeSection } from "../components/me/ResumeSection";
import { ContactFooterSection } from "../components/me/ContactFooterSection";
...
const sections = [
  ...
  { id: "principles", Component: PrinciplesSection },
...
export default function MePage() {
  ...
  const [text, setText] = useState("Know more about me");
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setTimeout(() => {
        ...
        setText((prev) => 
          prev === "Hi I'm Carl" ? "Know more about me" : "Hi I'm Carl" 
        );
        // Fade back in
        setFade(true);
  ...
  <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 h-16 sm:h-20 flex items-center justify-between">
    ...
    <nav className="hidden sm:flex items-center gap-3 sm:gap-6 text-xs sm:text-sm font-medium">
      ...
      <main className="flex w-full flex-col items-center gap-15">
        <div className="relative inline-flex w-full flex-col items-start flex-[0_0_auto] gap-2">
