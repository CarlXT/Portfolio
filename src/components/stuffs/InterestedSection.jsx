    ...
    >
      ...
      <div className="flex flex-col items-center justify-center max-w-5xl px-6 text-center relative w-full gap-6">
        <h2
          ...
          className="font-['SF_Compact-Bold',Helvetica] font-bold text-white text-6xl md:text-[80px] tracking-tight leading-tight"
        >
          Interested with my Stuff?
        </h2>
        <p 
        ...
        >
          Currently open to new opportunities. Let’s get in touch for new projects and collaborations.       
       </p>
      </div>
      ...
      <div className="flex items-center justify-center relative z-10">
        {ctaButtons.map((button, index) => (
          <PillButton 
            key={index}
            onClick={() => window.location.href = '/sayhi'}
          >
            {button.label} 
          </PillButton>
        ))}
