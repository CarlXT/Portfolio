...
export const AvailabilitySection = () => {
  const ctaButtons = [{ label: "Available for Work", href: "#contact"}];
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center max-w-5xl px-6 text-center relative w-full gap-6">
        ...
        >
          Currently open to new opportunities. I am available for new projects and collaborations.       
       </p>
      </div>
      ...
      <div className="flex items-center justify-center relative z-10">
        {ctaButtons.map((button, index) => (
          <PillButton 
            key={index}
            onClick={() => window.location.href = '#message-section'}
          >
            {button.label} 
          </PillButton>
        ))}
